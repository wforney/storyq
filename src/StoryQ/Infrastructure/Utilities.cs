namespace StoryQ.Infrastructure
{
    ...
    public static class Utilities
    {
        ...
        public static string UnCamel(this string input) => Regex.Replace(input, @"[\p{Lu}_]", x => " " + x.Value.ToLowerInvariant()).Trim();
        ...
        public static string Join(this IEnumerable<string> strings, string seperator) => string.Join(seperator, strings.ToArray());
