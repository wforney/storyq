namespace StoryQ
{
    ...
    {
        /// <summary>
        /// Initializes static members of the <see cref="StoryQSettings" /> class.
        /// </summary>
        static StoryQSettings()
        {
            ...
            DefaultMethodFormatSelector = x => x.Name.Contains("_", StringComparison.OrdinalIgnoreCase) ? inline : suffixed;
