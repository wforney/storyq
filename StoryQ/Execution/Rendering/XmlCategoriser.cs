namespace StoryQ.Execution.Rendering
{
    ...
    internal class XmlCategoriser
    {
        ...
        /// The chain
        /// </summary>
        private static readonly Dictionary<string, Func<MethodBase, string>> chain =
            new Dictionary<string, Func<MethodBase, string>>
            {
        ...
        public XmlCategoriser(XElement rootElement) => this.rootElement = rootElement;
