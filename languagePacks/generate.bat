...
for %%I in (src\*.txt) DO (
	...
	"%ProgramFiles(x86)%\Common Files\Microsoft Shared\TextTemplating\10.0\TextTransform.exe" -P ..\lib\development -a !!nameSpace!StoryQ.%%~nI -a !!inputFile!%%I -out obj\StoryQ.flit.%%~nI.g.cs ..\src\StoryQ\StoryQ.flit.tt 
